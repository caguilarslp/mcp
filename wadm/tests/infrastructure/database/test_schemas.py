...
def mock_db():
    ...
    # Mock collections
    db.trades = pytest.MagicMock()
    db.orderbook = pytest.MagicMock()
    db.klines = pytest.MagicMock()
    db.volume_profiles = pytest.MagicMock()
    db.order_flow = pytest.MagicMock()
    db.liquidity_levels = pytest.MagicMock()
    db.market_structure = pytest.MagicMock()
    db.collector_stats = pytest.MagicMock()
...
def mock_mongodb_client():
    ...
    client._db = None
    client.connect = pytest.AsyncMock()
    client.disconnect = pytest.AsyncMock()
    return client
