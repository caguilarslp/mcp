...
class Settings(BaseSettings):
    ...
    AUTO_START_COLLECTORS: bool = Field(default=True)
    BYBIT_SYMBOLS: List[str] = Field(default=["BTCUSDT", "ETHUSDT", "SOLUSDT"])
    BINANCE_SYMBOLS: List[str] = Field(default=["BTCUSDT", "ETHUSDT", "XRPUSDT"])
    COLLECTOR_STREAMS: List[str] = Field(default=["trades", "orderbook", "klines"])
